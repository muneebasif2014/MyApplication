...
public class update_dataholder {
    String case_status_up ,case_number_up, case_name_up , case_date_up ,case_update_up ;

    public update_dataholder(String case_status_up, String case_number_up, String case_name_up, String case_date_up, String case_update_up) {
        this.case_status_up = case_status_up;
        this.case_number_up = case_number_up;
    ...
    public String getCase_number_up() {
        return case_number_up;
    }

    public void setCase_number_up(String case_number_up) {
        this.case_number_up = case_number_up;
    }
